...
- Full access to MCP tools when available
- Full access to Browser tools for testing and verification
- Can use browser_action for E2E testing and UI verification