...
- Name: recipes/create.spec.ts >> Create Recipe >> should show validation errors for required fields
- Location: e2e/tests/recipes/create.spec.ts:37:3
...
Call log:
  - waiting for getByRole('button', { name: /create recipe/i })
